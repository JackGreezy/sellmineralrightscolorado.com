const SITE = {
  businessName: "Sell Mineral Rights Colorado",
  businessEmail: "colorado@sellmineralrightscolorado.com",
  siteUrl: "https://sellmineralrightscolorado.com"
};
...
async function sendEmail(to, lead) {
  ...
  const response = await fetch("https://api.sendgrid.com/v3/mail/send", {
    ...
    body: JSON.stringify({
      ...
      categories: ["mineral-rights-lead", "sellmineralrightscolorado-com"]
    })
  });
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return json(res, 500, {
      ok: false,
      error: "The form could not be submitted. Please call or email the Colorado review desk."
    });
  }
};
